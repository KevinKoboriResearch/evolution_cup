...
import 'package:mewnu/app/router/animations/fade_animation_page.dart';
    ...
    return Navigator(
      ...
      pages: [
        if (appState.selectedIndex == 0)
          ...
          FadeAnimationPage(
            child:CartsPage(), //Center(child: Container(child: Text('profile'),)),//ProfilePage(),
            key: const ValueKey('cartsPage'),
          ),
        if (appState.selectedIndex == 2)
          FadeAnimationPage(
            child:
               CompaniesManagerPage(), //Center(child: Container(child: Text('store'),)),//StorePage(),

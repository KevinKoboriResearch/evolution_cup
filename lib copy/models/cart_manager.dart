...
import 'package:evolutioncup/models/address.dart';
...
import 'package:evolutioncup/services/cepaberto_service.dart';
...
class CartManager extends ChangeNotifier {
  ...
  Future<bool> calculateDelivery(double lat, double long) async {
    final DocumentSnapshot doc = await firestore.document('aux/delivery').get();//'aux/qqI3IWWp3p8pcKgCOufz/delivery/qiaXNK8D118xHyVdeRCU').get();

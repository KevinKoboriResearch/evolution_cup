...
import 'package:evolutioncup/services/cielo_payment.dart';
...
class CheckoutManager extends ChangeNotifier {
  ...
  Future<int> _getOrderId() async {
    final ref = firestore.document('aux/orderCounter');//'aux/qqI3IWWp3p8pcKgCOufz/orderCounter/g7Pam3V2eZXNytN1lL5V');

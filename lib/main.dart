...
import 'package:mewnu/router/route_information_parser.dart';
import 'package:mewnu/router/router_delegate.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return MultiProvider(
      providers: [
        ...
        //       ordersManager..updateUser(context, userManager),
        // ),
        // ChangeNotifierProxyProvider<UserManager, AdminUsersManager>(
        //   create: (context) => AdminUsersManager(),
        //   lazy: false,
        //   update: (_, userManager, adminUsersManager) =>
        //       adminUsersManager..updateUser(context, userManager),
        // ),
        // ChangeNotifierProxyProvider<UserManager, AdminOrdersManager>(
        //   create: (context) => AdminOrdersManager(),
        //   lazy: false,
        //   update: (_, userManager, adminOrdersManager) => adminOrdersManager
        //     ..updateAdmin(context, userManager.adminEnabled(context)),
        // ),
      ],
